...
*/
#ifdef HAS_SCREEN
  display_obj.tft.drawCentreString("ESP32 Marauder", TFT_WIDTH / 2,
                                   TFT_HEIGHT * 0.33, 1);
  display_obj.tft.drawCentreString("JustCallMeKoko", TFT_WIDTH / 2,
                                   TFT_HEIGHT * 0.5, 1);
  display_obj.tft.drawCentreString(display_obj.version_number, TFT_WIDTH / 2,
                                   TFT_HEIGHT * 0.66, 1);
#endif
...
// Do some stealth mode stuff
  ...
  // Serial.println("Internal Temp: " + (String)((temprature_sens_read() - 32)
  // / 1.8));

  settings_obj.begin();

  // Serial.println("This is a test Channel: " +
  // (String)settings_obj.loadSetting<uint8_t>("Channel")); if
  // (settings_obj.loadSetting<bool>( "Force PMKID"))
